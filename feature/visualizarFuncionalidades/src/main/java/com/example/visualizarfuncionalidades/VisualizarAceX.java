...
public class VisualizarAceX {

   public static void LlenarGraficaAceX(Context context, LineChart acelerometro, People people, DataPeople dato, Sennales sennales){
        Bd_manager_Sennales manager = new Bd_manager_Sennales(context);
        ArrayList<Float> sennalesArrayList = manager.SennalesMismaFechaAceX(people.getCi(),dato,sennales);
