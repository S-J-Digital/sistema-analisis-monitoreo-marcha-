...
public class LogDto {
    ...
    public LogDto(@NotNull(message = "El estado no puede ser null") String log_level, String user_name, @NotNull(message = "El IP no puede ser null") String ip_adress, String message, String method, double tiempo_ejecucion) {
