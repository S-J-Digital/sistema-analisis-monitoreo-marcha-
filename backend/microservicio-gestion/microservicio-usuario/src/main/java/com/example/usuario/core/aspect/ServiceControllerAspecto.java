...
public class ServiceControllerAspecto {
    ...
    @Autowired
    public ServiceControllerAspecto(LogsService logsService) {
        this.logsService = logsService;
    }

    @Around(value = "execution(* com.example.usuario.core.serviceController.serviceControllerImpl.*.*(..))")
    public Object logAroundServiceController(ProceedingJoinPoint joinPoint) throws Throwable {
