...
public class VisualizarAceY {

    public static void LlenarGraficaAceY(Context context, LineChart acelerometro, People people, DataPeople dato, Sennales sennales){
        Bd_manager_Sennales manager = new Bd_manager_Sennales(context);
        ArrayList<Float> sennalesArrayList = manager.SennalesMismaFechaAceY(people.getCi(),dato,sennales);
